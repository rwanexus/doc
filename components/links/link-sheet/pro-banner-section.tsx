...
export function ProBannerSection({
  ...
  return (
    <div className="pb-5">
      <LinkItem
        title="Show Secured by Doc"
        tooltipContent="Display 'Secured by Doc' branding on your shared documents"
        link="https://doc.rwa.nexus/help/article/remove-papermark-branding"
        enabled={enabled}
